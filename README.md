...
2. **Set up the database**: run the `CREATE TABLE` statement and load the Netflix titles CSV into `netflix_titles`.  dataset link: [![Kaggle Dataset](https://shields.io)](https://kaggle.com)
